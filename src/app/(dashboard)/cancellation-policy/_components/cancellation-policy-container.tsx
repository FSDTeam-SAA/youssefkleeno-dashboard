  ...
  return (
    <div className="py-[30px] shadow-[0px_4px_5px_0px_#0000001A] bg-white rounded-[16px] border-t mb-10">
      ...
      <div className="flex flex-col gap-8 px-6">
        ...
        <div>
          <Link href="/cancellation-policy/add-cancellation-policy">
            <button className="flex items-center gap-2 text-base font-normal leading-[120%] text-white py-[11px] px-[17px] rounded-[6px] bg-[#499FC0] ">
              <Plus /> Add Policy
            </button>
          </Link>
        </div>
      ...
      <div className="px-6 pt-10">
        <p className=" text-xl font-normal text-black leading-[120%]">
          Our cancellation policy is as follows:
        </p>
        <ul className="list-disc list-inside pt-6">
          <li className="text-xl font-normal text-black leading-[120%]">
            More than 24 hours before: Full refund
          </li>
          <li className="text-xl font-normal text-black leading-[120%] py-4">
