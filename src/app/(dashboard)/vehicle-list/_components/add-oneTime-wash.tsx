...
const formSchema = z.object({
  ...
  vehicleImage: z.any().refine((file) => file instanceof File, {
...
export default function AddoneTimewash() {
  ...
  const addOntimeWashMutation = useMutation({
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      formData.append("washType", "One-time Wash"); // fixed washType
      formData.append("vehicleImage", values.vehicleImage);

      addOntimeWashMutation.mutate(formData);
    } catch (error) {
          ...
          >
            ...
            <div className="flex justify-center gap-4">
              ...
              <Button
                ...
                disabled={addOntimeWashMutation.isPending}
              >
                {addOntimeWashMutation.isPending ? "Saving..." : "Save"}
              </Button>
            </div>
          </form>
        </Form>
